...
public class Login_2 extends CommonPage {
    ...
    private final By email = By.id("companyUsername");
    private final By pass = By.id("password");
    private final By taxcode = By.xpath("//input[@id='taxCode']");
    private final By btnLogin = By.xpath("//button[contains(text(),'Đăng nhập')]");
   ...
   // private final By table = By.xpath("//body/div[3]/div[2]/div[1]/div[1]/div[1]");
    ...
    public void testLogin() throws InterruptedException {
        commonFuncs = new CommonFuncs(driver);
        commonFuncs.setText(email, "caonv174@gmail.com");
        Thread.sleep(100);
        commonFuncs.setText(pass, "123456");
        Thread.sleep(100);
        commonFuncs.setText(taxcode, "0312303803-999");
        Thread.sleep(100);
        commonFuncs.clickElement(btnLogin);
        pause(40);
    }
